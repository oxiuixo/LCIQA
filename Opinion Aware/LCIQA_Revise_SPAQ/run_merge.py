...
from models.LCIQA import QMerge
...
def main():
    ...
    regress_net = QMerge().cuda()
    regress_net.merg.train(True)
    ...
    upnet4to3.eval()
    paramQ = [
        {'params': regress_net.merg.parameters(), 'lr': myconfig.lr},
    ]
